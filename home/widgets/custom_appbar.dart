...
class HomeScreenAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  const HomeScreenAppBar({
    ...
    super.key, required this.currentUserNotifier,
  });
                ...
                child: Row(
                  ...
                  children: [
                    LeftSection(
                      ...
                      sectionWidth:
                          isCompactView ? compactSearchBarWidth : sidePartWidth,
                    ...
                    HomeAppBarActionButtons(
                      rightWidth:
                          isCompactView ? compactActionButtonsWidth : sidePartWidth,
                      deviceWidth: deviceWidth,
                      isCompactView: isCompactView,
            ...
            ...[
              ...
              if(!isCompactView)
                ...
                IconElevatedButton(
                  ...
                  icon: SvgPicture.asset(AppIcons.createNewPost, width: 20, height: 20),
              ...
              itemBuilder: (context) => [
                PopupMenuItem(
                  ...
                  child: IconElevatedButton(
                    ...
                    icon: const Icon(Icons.social_distance, color: AppColors.dynamicBlack,),
                ...
                PopupMenuItem(
                  ...
                  child: IconElevatedButton(
                    style: AppTheme.navigationIconButtonStyle,
                    icon: const Icon(Icons.earbuds, color: AppColors.dynamicBlack,),
                ...
                if(currentUser != null)
                  ...
                  child: IconElevatedButton(
                    style: AppTheme.navigationIconButtonStyle,
                    icon: const Icon(Icons.logout, color: AppColors.dynamicBlack,),
