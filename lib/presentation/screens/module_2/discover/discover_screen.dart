            ...
            children: [
              ...
              ValueListenableBuilder<String>(
                ...
                builder: (context, searchQuery, _) {
                  return Text(
                    searchQuery.isEmpty ? 'Some collections that you may like' : 'Search result',
              ...
              ValueListenableBuilder<String>(
                valueListenable: searchQueryNotifier,
                builder: (context, searchQuery, _) {
                  Future<List<CollectionModel>> futureCollections = searchQuery.isEmpty
                      ? serviceLocator.get<CollectionService>().getCollectionsOrderByAssets()
                      : serviceLocator.get<CollectionService>().getCollectionsFromQuery(searchQuery);
                                        ...
                                        child: GestureDetector(
                                          onTap: () {
                                            ...
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                builder: (context) => CollectionViewingScreen(
